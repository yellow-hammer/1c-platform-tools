...
- **Инициализация:** без файла `packagedef` панель скрыта; команда «1C: Зависимости: Инициализировать packagedef» из палитры создаёт проект и сразу включает панель без перезагрузки
